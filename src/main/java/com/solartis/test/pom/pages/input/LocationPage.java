...
public class LocationPage extends PomEventsMethodDefinition {
	...
	public void loc_addr() throws POMEventException
	{
		
			FireEventobject.ClickElement(loc_addr_yes);
		
	}
	
	public void select_protclass(String protection_class) throws POMEventException
	{
		
			FireEventobject.Dropdown(prot_class, protection_class);
		
	}
	
	public void select_no_stories(String number_of_stories) throws POMEventException
	{
		
			FireEventobject.Dropdown(no_of_stories, number_of_stories);
	...
	public void select_no_losses(String number_loss) throws POMEventException 
	{
		
			FireEventobject.Dropdown(no_of_losses, number_loss);
		
	}
	
	public void click_save() throws POMEventException
	{
		
			FireEventobject.ClickElement(location_save);
		
	}
	
	public void click_cont_uw() throws POMEventException
	{
		
			FireEventobject.ClickElement(continue_uw);
		
	}

	public UnderwritingPage Location(String protection_class, String number_of_stories, String number_loss, String test_data)throws POMPageException 
	{
		try
		{
		...
		catch(InterruptedException | POMEventException e)
		{
			...
			{
				throw new POMPageException("Error in Taking ScreenShot in Location Page", e);
			}
